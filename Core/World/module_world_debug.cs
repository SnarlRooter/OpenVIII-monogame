...
#pragma warning restore 0649
        ...
        private static void ReadWorldMapFiles()
        {
            ...
            var languageShort = Extended.GetLanguageShort(true);
            var languageTranslated = (languageShort == "es") ? "sp" : languageShort;
            var wmPath = aw.GetListOfFiles().Where(x => x.ToLower().Contains($"wmset{languageTranslated}.obj")).Select(x => x).First();
